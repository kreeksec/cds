...
const descriptionMap: Record<string, string[]> = {
  ...
  '⬇️': ['enableVoting', 'settled', 'lowFees', 'formDownload', 'moneyEarn'],
  ...
  balance: ['futures', 'assetMeasurements', 'stableCoinMetaphor', 'futuresCoinbaseOne'],
  risk: ['futures', 'riskStaking', 'futuresCoinbaseOne'],
  clock: ['futures', 'waitingForConsensus', 'timingCheck', 'fast', 'clock', 'futuresCoinbaseOne'],
  coin: [
    'futures',
    'apyInterest',
    'congratulations',
